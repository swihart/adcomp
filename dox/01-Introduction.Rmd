...
defines for us. To see which macros are available start typing
...
See also the file `r doxylink("matrix_array_operations.pdf")` for a quick overview.
...
This is the first real illustrations of how distributions can be used
